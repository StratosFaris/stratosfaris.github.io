...
export const Education: React.FC = () => {
  ...
  return (
    <section id="education" className="py-12 sm:py-16 md:py-20 relative bg-abyss z-10">
      <div className="max-w-[1440px] mx-auto px-4 sm:px-6 md:px-12 relative z-10">
        ...
        {/* Academic Card */}
        <div className="glass-panel rounded-md p-5 sm:p-8 md:p-10 border border-white/10 relative">
          <div className="flex flex-col lg:flex-row lg:items-start justify-between gap-6 sm:gap-8">
            
            <div className="flex-1">
              <div className="flex flex-wrap items-center gap-2 sm:gap-3 mb-2">
                <PiDogBold className="w-5 h-5 sm:w-6 sm:h-6 text-cyan" />
                <h3 className="font-sora text-xl sm:text-2xl md:text-3xl font-bold text-white">
                  {education.school} <span className="text-white/40 font-normal">| {education.location}</span>
                </h3>
              </div>

              <p className="font-mono text-sm sm:text-base text-cream font-medium mb-6 sm:mb-8">
                {education.degree}
              </p>
